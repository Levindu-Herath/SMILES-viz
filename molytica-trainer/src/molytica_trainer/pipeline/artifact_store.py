...
The trainer package only supports the WL encoder + FDDLGPU dict learner combo,
so those classes are imported directly instead of going through a registry.
"""
...
def load_bundle(bundle_dir):
    ...
    encoder = WL.load(os.path.join(bundle_dir, ENCODER_SUBDIR))
    dict_learner = FDDLGPU.load(os.path.join(bundle_dir, DICT_LEARNER_SUBDIR))
